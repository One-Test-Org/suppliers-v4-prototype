...
var nationalities = [
  { value: "Austrian", code: "Austrian", selected: false },
  { value: "Belgian", code: "Belgian", selected: false },
  { value: "Bulgarian", code: "Bulgarian", selected: false },
  { value: "Belarusian", code: "Belarusian", selected: false },
  { value: "British", code: "British", selected: false },
  { value: "Croatian", code: "Croatian", selected: false },
  { value: "Cypriot", code: "Cypriot", selected: false },
  { value: "Czech", code: "Czech", selected: false },
  { value: "Danish", code: "Danish", selected: false },
  { value: "Estonian", code: "Estonian", selected: false },
  { value: "Finnish", code: "Finnish", selected: false },
  { value: "French", code: "French", selected: false },
  { value: "German", code: "German", selected: false },
  { value: "Greek", code: "Greek", selected: false },
  { value: "Hungarian", code: "Hungarian", selected: false },
  { value: "Icelander", code: "Icelander", selected: false },
  { value: "Irish", code: "Irish", selected: false },
  { value: "Italian", code: "Italian", selected: false },
  { value: "Kosovar", code: "Kosovar", selected: false },
  { value: "Latvian", code: "Latvian", selected: false },
  { value: "Lithuanian", code: "Lithuanian", selected: false },
  { value: "Luxembourger", code: "Luxembourger", selected: false },
  { value: "Maltese", code: "Maltese", selected: false },
  { value: "Moldovan", code: "Moldovan", selected: false },
  { value: "Dutch", code: "Dutch", selected: false },
  { value: "North Macedonian", code: "North Macedonian", selected: false },
  { value: "Norwegian", code: "Norwegian", selected: false },
  { value: "Polish", code: "Polish", selected: false },
  { value: "Portuguese", code: "Portuguese", selected: false },
  { value: "Romanian", code: "Romanian", selected: false },
  { value: "Russian", code: "Russian", selected: false },
  { value: "San Marino", code: "San Marino", selected: false },
  { value: "Serbia", code: "Serbia", selected: false },
  { value: "Slovakia", code: "Slovakia", selected: false },
  { value: "Slovenia", code: "Slovenia", selected: false },
  { value: "Spanish", code: "Spanish", selected: false },
  { value: "Swedish", code: "Swedish", selected: false },
  { value: "Swiss", code: "Swiss", selected: false },
  { value: "Ukrainian", code: "Ukrainian", selected: false },
];
